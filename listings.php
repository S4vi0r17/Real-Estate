  ...
  <div class="listing-container">
    <div class="listing">
      ...
      <div class="listing-content">
        ...
        <a href="house1.html" class="btn-yellow-block"> View Property </a>
      </div>
    </div>
    <div class="listing">
      <picture>
    ...
    <div class="listing">
      <picture>
        ...
        <img loading="lazy" src="build/img/anuncio4.jpg" alt="Listing1" />
      </picture>
      <div class="listing-content">
        <h3>House with Pool</h3>
        <p>
    ...
    <div class="listing">
      <picture>
        ...
        <img loading="lazy" src="build/img/anuncio5.jpg" alt="Listing1" />
      </picture>
      <div class="listing-content">
        <h3>House with Pool</h3>
        <p>
    ...
    <div class="listing">
      <picture>
        ...
        <img loading="lazy" src="build/img/anuncio6.jpg" alt="Listing1" />
      </picture>
      <div class="listing-content">
        <h3>House with Pool</h3>
        <p>
