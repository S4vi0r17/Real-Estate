...
CREATE TABLE
    IF NOT EXISTS `bienesraices_crud`.`vendedores` (
...
CREATE TABLE
    IF NOT EXISTS `bienesraices_crud`.`propiedades` (
        `id` INT(11) NOT NULL AUTO_INCREMENT,
        ...
        CONSTRAINT `Vendedores_id` FOREIGN KEY (`vendedores_id`) REFERENCES `bienesraices_crud`.`vendedores` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
    ) ENGINE = InnoDB;
